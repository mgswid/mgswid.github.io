		...
		createCarousel() {
			const t = document.createElement("template"),
				...
				s = this.sources.map(((t, s) => {
					...
					const n = this.settings.constrain ? "mw-100 h-auto w-auto m-auto top-0 end-0 bottom-0 start-0" : "h-100 w-100";
					let l = '<img src="'.concat(t, '" class="d-block ').concat(n, ' img-fluid" style="z-index: 1; object-fit: contain;" />'),
						r = "";
					const c = this.getInstagramEmbed(t),
						d = this.getYoutubeId(t);
					this.isEmbed(t) && !i && (d && (t = "https://www.youtube.com/embed/".concat(d), r = 'title="YouTube video player" frameborder="0" allow="accelerometer autoplay clipboard-write encrypted-media gyroscope picture-in-picture"'), l = c || '<iframe src="'.concat(t, '" ').concat(r, " allowfullscreen></iframe>")), o && (l = t);
					const h = new URLSearchParams(t.split("?")[1]);
					let u = "";
					return h.get("caption") && (u = '<p class="lightbox-caption m-0 p-2 text-center text-white small"><em>'.concat(h.get("caption"), "</em></p>")), '\n\t\t\t\t<div class="carousel-item '.concat(s ? "" : "active", '" style="min-height: 100px">\n\t\t\t\t\t').concat('<div class="position-absolute top-50 start-50 translate-middle text-white"><div class="spinner-border" style="width: 3rem height: 3rem" role="status"></div></div>', '\n\t\t\t\t\t<div class="ratio ratio-16x9" style="background-color: #000;">').concat(l, "</div>\n\t\t\t\t\t").concat(u, "\n\t\t\t\t</div>")
				})).join(""),
